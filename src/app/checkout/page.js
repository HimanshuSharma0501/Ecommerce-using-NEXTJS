...
export default function Checkout() {
  ...
  const publishableKey =
    "pk_test_51OD84PSFykD99k8qCt1DSOZiMZoyIg1hKXb82L1Hvj9upLFFjGkPGgGbsBzusQ7adOk61BmalyyqXm48Hs6rUWCk00g7b0J7J0";
  ...
  if (isOrderProcessing) {
    return (
      <div className="w-full min-h-screen flex justify-center text-black items-center">
        <PulseLoader
          color={"#000000"}
