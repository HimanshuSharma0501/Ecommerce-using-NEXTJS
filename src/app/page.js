        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-suto  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">
              This is some random text which is added to ecommerce web page
              created by Himanshu Sharma using NextJS. It uses stripe for
              payment gateway and firebase to store url of images to be
              displayed on web page. <br /> Thanks
            </p>
